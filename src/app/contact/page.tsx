...
import { getTelegramSettings, CachedTelegramSettings } from '@/lib/settingsCache';

export default function ContactPage() {
    const [loading, setLoading] = useState(false);
    const [success, setSuccess] = useState(false);
    const [telegram, setTelegram] = useState<CachedTelegramSettings | null>(null);
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-2xl text-gray-300">
            ...
            {/* Telegram Channel CTA — shows only if Telegram is active */}
            {telegram?.is_active && telegram.telegram_url && (
                <div className="mt-8 text-center">
                    <p className="text-gray-500 mb-3">Join our Telegram {telegram.telegram_type === 'group' ? 'Group' : 'Channel'} for updates</p>
                    <a
                        href={telegram.telegram_url}
                        target="_blank"
                    ...
                    >
                        ...
                        Join {telegram.telegram_type === 'group' ? 'Group' : 'Channel'}
                    </a>
                </div>
            )}
        </div>
